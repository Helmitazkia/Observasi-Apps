    ...
    <div id="sidebar"  class="nav-collapse" style="background-color:#545454;" >
      ...
      <ul class="sidebar-menu" id="nav-accordion">
        ...
        <li class="sub-menu">
          ...
          <ul class="sub">
            <li id="idMailInvoice" style="padding-left:25px;"><a href="<?php echo base_url('myapps/getMailRegInv'); ?>"><i class="fa fa-envelope-o"></i> Mail & Invoice</a></li>
          </ul>
          <ul class="sub-menu" style="padding-left: 5px;width: 100%;">
            <li class="sub-menu" style="margin-right: 0px;" id="idSubCuti">
              <a href="javascript:;" id="idMyAppsCuti">
                <i class="fa fa-briefcase"></i><span>Cuti</span>
              </a>
              <ul class="sub">
                <li id="idCuti"><a href="<?php echo base_url('cuti/getCuti'); ?>">Persetujuan Cuti</a></li>
              </ul>
              <ul class="sub">
                <li id="idStsCuti"><a href="<?php echo base_url('cuti/getHistory'); ?>">Status Cuti</a></li>
              </ul>
            </li>
          </ul>
          <ul class="sub-menu" style="padding-left: 5px;width: 100%;">
            <li class="sub-menu" style="margin-right: 0px;" id="idSubSO">
              <a href="javascript:;" id="idMyAppsVessel">
                <i class="fa fa-anchor"></i><span>Ship Operation</span>
              </a>
              <ul class="sub">
                <li id="idVesselTrack"><a href="<?php echo base_url('shipOperation'); ?>">Vessel Tracking</a></li>
              </ul>
            </li>
          </ul>
            <!-- <ul class="sub">
