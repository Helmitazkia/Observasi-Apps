	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$("#btnSave").click(function(){
				...
				$.post('<?php echo base_url("myapps/addUserDivSetting"); ?>',
				{   
					usrId : usrId,fullName : fullName,divisiNya : divisiNya
				},
					function(data) 
					{	
						alert(data);
		    ...
		    $("#searchSlcUsrName").change(function(){
		    	...
		    	usrId = $(this).val();
		    	$.post('<?php echo base_url("myapps/userDivSettingSearch"); ?>',
				{   
					usrId : usrId
				},
					function(data) 
		...
		function delData(id)
		{
			...
			if(cfm)
			{
				$.post('<?php echo base_url("myapps/delUserDivSetting"); ?>',
				{ id : id },
				function(data) 
				{
					reloadPage();
		...
		function reloadPage()
		{
			window.location = "<?php echo base_url('myapps/userDivSetting');?>";
		}
	</script>
</head>
<body>
	<section id="container">
		<section id="main-content">
			<section class="wrapper site-min-height" style="min-height:400px;">
				<h3>
					<i class="fa fa-angle-right"></i> Custom Divisi<span style="padding-left: 20px;" id="idLoading"><img src="<?php echo base_url('assets/img/loading.gif'); ?>" ></span>
				</h3>
								...
								<table class="table table-border table-striped table-bordered table-condensed table-advance table-hover">
									<thead>
										<tr style="background-color: #ba5500;color: #FFF;">
											...
											<th style="vertical-align: middle; width:40%;text-align:center;">Custom Divisi</th>											
						...
						<div class="form-panel">
							...
							<div class="col-md-6 col-xs-12">
								<div class="form-group">
								    ...
								    <select name="slcDivisi" id="slcDivisi" class="form-control input-sm">
								    	<option value="0">- Select -</option>
								    	<?php echo $optDiv; ?>
								    </select>
								</div>
