	...
	<script type="text/javascript">
		$(document).ready(function(){
		    ...
		    $("#btnSearch").click(function(){
		    	...
		    	$("#idLoading").show();
		    	$.post('<?php echo base_url("cuti/getCuti/search"); ?>',
				{   
		...
		function actionCuti(empNo,sDate,eDate,uniqKey)
		{
			var st = confirm("approved..??");
			if(st)
			{
				$.post('<?php echo base_url("cuti/approve"); ?>',
				{   
		...
		function actionReject(empNo,sDate,eDate,uniqKey)
		{
			...
			{
				var remark = st;
				$.post('<?php echo base_url("cuti/reject"); ?>',
				{   
		...
		function reloadPage()
		{
			window.location = "<?php echo base_url('cuti/getCuti');?>";
		}
	</script>
</head>
<body>
