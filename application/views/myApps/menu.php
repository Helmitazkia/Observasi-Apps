      ...
      { userId : userId },
        ...
        { 
          $.each( data, function( key, value ) {
            if(value.name_apps == "Surat"){ $("#idSurat").show(); }
            if(value.name_apps == "Mail & Invoice"){ $("#idMailInvoice").show(); }
            if(value.name_apps == "Status Cuti"){ $("#idStsCuti").show(); $("#idSubCuti").show(); }
            if(value.name_apps == "Persetujuan Cuti"){ $("#idCuti").show(); $("#idSubCuti").show(); }
            if(value.name_apps == "Pengajuan Ijin"){ $("#idStsIjin").show(); $("#idSubIjin").show(); }
            if(value.name_apps == "Persetujuan Ijin"){ $("#idPrstjnIjin").show(); $("#idSubIjin").show(); }
            if(value.name_apps == "Vessel Tracking"){ $("#idVesselTrack").show(); $("#idSubSO").show(); }
            if(value.name_apps == "Voyage Estimate"){ $("#idVoyEst").show(); $("#idSubCommercial").show(); }
            if(value.name_apps == "Statistik"){ $("#idByTrip").show(); $("#idSubStatistik").show(); }
            if(value.name_apps == "Survey Customer"){ $("#idReportSurvey").show(); $("#idSubSurveyCust").show(); }
          });
        },
      "json"
      );
...
<section id="container">
  <header class="header black-bg" style="background-color:#D46D16;border-bottom:1px solid #e7e7e7" id="idHeaderNya">
    ...
    <div id="sidebar"  class="nav-collapse" style="background-color:#545454;" >
      ...
      <ul class="sidebar-menu" id="nav-accordion">
        ...
        <li class="sub-menu">
          ...
          <ul class="sub">
            <li id="idSurat" style="padding-left:25px;display:none;"><a href="<?php echo base_url('myLetter/'); ?>"><i class="fa fa-inbox"></i> Surat</a></li>
          </ul>
          <ul class="sub">
            <li id="idMailInvoice" style="padding-left:25px;display:none;"><a href="<?php echo base_url('myapps/getMailRegInv'); ?>"><i class="fa fa-envelope-o"></i> Mail & Invoice</a></li>
          </ul>
          <ul class="sub-menu" style="padding-left: 5px;width: 100%;">
            <li class="sub-menu" style="margin-right: 0px;display:none;" id="idSubCuti">
              ...
              <ul class="sub">
                <li id="idCuti" style="display:none;"><a href="<?php echo base_url('cuti/getCuti'); ?>">Persetujuan Cuti</a></li>
              </ul>
              <ul class="sub">
                <li id="idStsCuti" style="display:none;"><a href="<?php echo base_url('cuti/getHistory'); ?>">Status Cuti</a></li>
              </ul>
            </li>
          </ul>
          <ul class="sub-menu" style="padding-left: 5px;width: 100%;">
            <li class="sub-menu" style="margin-right: 0px;display:none;" id="idSubIjin">
              ...
              <ul class="sub">
                <li id="idStsIjin" style="display:none;"><a href="<?php echo base_url('ijin/requestIjin'); ?>">Pengajuan Ijin</a></li>
              </ul>
              <ul class="sub">
                <li id="idPrstjnIjin" style="display:none;"><a href="<?php echo base_url('ijin/getApproveIjin'); ?>">Persetujuan Ijin</a></li>
              </ul>              
            </li>
          </ul>
          <ul class="sub-menu" style="padding-left: 5px;width: 100%;">
            <li class="sub-menu" style="margin-right: 0px;display:none;" id="idSubSO">
              ...
              <ul class="sub">
                <li id="idVesselTrack" style="display:none;"><a href="<?php echo base_url('shipOperation'); ?>">Vessel Tracking</a></li>
              </ul>
            </li>
          </ul>          
          <ul class="sub-menu" style="padding-left: 5px;width: 100%;">
            <li class="sub-menu" style="margin-right: 0px;display:none;" id="idSubCommercial">
              ...
              <ul class="sub">
                <li id="idVoyEst" style="display:none;"><a href="<?php echo base_url('shipCommercial/getVoyageEst'); ?>">Voyage Estimator</a></li>
              </ul>
            </li>
          </ul>
          <ul class="sub-menu" style="padding-left: 5px;width: 100%;">
            <li class="sub-menu" style="margin-right: 0px;display:none;" id="idSubSurveyCust">
              ...
              <ul class="sub">
                <li id="idReportSurvey" style="display:none;"><a href="<?php echo base_url('surveyCustomer/getDataSurvey'); ?>">Surveyed List</a></li>
              </ul>
            </li>
          </ul>
          <ul class="sub-menu" style="padding-left: 5px;width: 100%;">
            <li class="sub-menu" style="margin-right: 0px;display:none;" id="idSubStatistik">
              ...
              <ul class="sub">
                <li id="idByTrip" style="display:none;"><a href="<?php echo base_url('statistik/getByTrip'); ?>">By Trip</a></li>
              </ul>
            </li>
          </ul>
            <!-- <ul class="sub">
