	...
	<script type="text/javascript">
		$(document).ready(function(){
		    ...
		    $("#btnSearch").click(function(){
		    	...
		    	$("#idLoading").show();
		    	$.post('<?php echo base_url("ijin/getApproveIjin/search"); ?>',
				{   
		...
		function actionIjin(empNo,sDate,eDate,uniqKey)
		{
			var st = confirm("Approved..??");
			if(st)
			{
				$.post('<?php echo base_url("ijin/approveIjin"); ?>',
				{   
					empNo : empNo,sDate : sDate,eDate : eDate,uniqKey : uniqKey
				},
					function(data) 
					{	
						reloadPage();
		...
		function actionReject(empNo,sDate,eDate,uniqKey)
		{
			var st = prompt("Reject Reason :", "");
			if(st != null && st != '')
			{
				var remark = st;
				$.post('<?php echo base_url("ijin/rejectIjin"); ?>',
				{   
					empNo : empNo,sDate : sDate,eDate : eDate,remark : remark,uniqKey : uniqKey
				},
					function(data) 
					{	
						reloadPage();
		...
		function reloadPage()
		{
			window.location = "<?php echo base_url('ijin/getApproveIjin');?>";
		}
	</script>
</head>
<body>
	<section id="container">
		<section id="main-content">
			<section class="wrapper site-min-height" style="min-height:400px;">
				<h3>
					<i class="fa fa-angle-right"></i> Persetujuan Ijin<span style="padding-left: 20px;" id="idLoading"><img src="<?php echo base_url('assets/img/loading.gif'); ?>" ></span>
				</h3>
